 ...
 */
final class Version20200417151528 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE shift DROP number_of_hours, CHANGE note note VARCHAR(255) DEFAULT NULL, CHANGE overtime_duty_rooster overtime_duty_rooster TINYINT(1) DEFAULT NULL, CHANGE count_time_before_work count_time_before_work TINYINT(1) DEFAULT NULL, CHANGE count_time_after_work count_time_after_work TINYINT(1) DEFAULT NULL');
