 ...
 */
final class Version20200416111000 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE duty_rooster (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, date DATETIME NOT NULL, start_time TIME NOT NULL, end_time TIME NOT NULL, number_of_hours INT NOT NULL, count_time_before_work SMALLINT NOT NULL, count_time_after_work SMALLINT NOT NULL, note VARCHAR(255) DEFAULT NULL, avoid_christmas SMALLINT NOT NULL, INDEX IDX_E59402B2A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE duty_rooster ADD CONSTRAINT FK_E59402B2A76ED395 FOREIGN KEY (user_id) REFERENCES user (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE duty_rooster');
